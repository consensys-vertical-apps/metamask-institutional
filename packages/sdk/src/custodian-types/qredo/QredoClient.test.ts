...
describe("#QredoClient", () => {
  ...
  describe("getAccessToken", () => {
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      await expect(qredoClient.getAccessToken()).rejects.toThrow(
        CustodianApiError
      );
    });
    ...
    it("should fail if no access token is returned", async () => {
      ...
      expect(qredoClient.getAccessToken()).rejects.toThrowError(
        "No access token"
      );
    });
  ...
  describe("getEthereumAccounts", () => {
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      await expect(qredoClient.getEthereumAccounts()).rejects.toThrow(
        CustodianApiError
      );
    });
  ...
  describe("createTransaction", () => {
    it("should POST the /custodian/transaction endpoint", async () => {
      fetchMock.mockResponses(
        [
          JSON.stringify({ access_token: "123", refresh_token: "token" }),
          { status: 200 },
        ],
    ...
    it("should support EIP-1559 transactions", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(
        `https://qredo/connect/transaction`,
        {
          body:
            '{"to":"test","from":"0xtest","value":"test","data":"test","gasLimit":"test","chainID":"42","maxPriorityFeePerGas":"test","maxFeePerGas":"test"}',
  ...
  describe("getTransaction", () => {
    it("should GET the /custodian/transaction/:id endpoint", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(
        "https://qredo/connect/transaction/xxx",
        {
          headers: {
            Authorization: "Bearer 123",
          },
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      await expect(qredoClient.getTransaction("xxx")).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("getTransactions", () => {
    it("should throw an error", async () => {
      await expect(qredoClient.getTransactions()).rejects.toThrowError(
        "Not implemented yet"
      );
    });
  });
  ...
  describe("getCustomerProof", () => {
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      await expect(qredoClient.getCustomerProof()).rejects.toThrow(
        CustodianApiError
      );
    });
    ...
    it("should call the customer proof endpoint", async () => {
      ...
      expect(fetchMock).toHaveBeenLastCalledWith(
        "https://qredo/connect/customer-proof",
        {
          headers: { Authorization: "Bearer 123" },
          method: "POST",
        }
  ...
  describe("getSignedMessage", () => {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      await expect(qredoClient.getSignedMessage("xxx")).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("getNetworks", () => {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      await expect(qredoClient.getNetworks()).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("QredoClient#signPersonalMessage", () => {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(qredoClient.signPersonalMessage("test", message)).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("QredoClient#signTypedData_v4", () => {
    it("should POST the /sign endpoint", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(`https://qredo/connect/sign`, {
        body:
          '{"from":"test","payload":{"types":{"EIP712Domain":[]},"primaryType":"test","domain":{"name":"test"},"message":{}}}',
        headers: {
          Authorization: "Bearer 123",
        },
        method: "POST",
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(qredoClient.signTypedData_v4("test", buffer)).rejects.toThrow(
        CustodianApiError
      );
    });
  });
