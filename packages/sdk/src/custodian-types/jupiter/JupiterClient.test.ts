...
describe("JupiterClient", () => {
  ...
  describe("JupiterClient#getEthereumAccounts", () => {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(jupiterClient.getEthereumAccounts()).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("JupiterClient#createTransaction", () => {
    it("should POST the /custodian/transaction endpoint", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(
        ...
        {
          body:
            '{"to":"test","accountId":"test","value":"test","data":"test","type":"0","gasLimit":"test","network":"4","gasPrice":"test"}',
          headers: {
    ...
    it("should POST the /custodian/transaction endpoint with EIP-1559 params", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(
        ...
        {
          body:
            '{"to":"test","accountId":"test","value":"test","data":"test","type":"2","gasLimit":"test","network":"4","maxPriorityFeePerGas":"test","maxFeePerGas":"test"}',
          headers: {
            Authorization: "Bearer mock-jwt",
          },
          method: "POST",
  ...
  describe("JupiterClient#getTransactions", () => {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(jupiterClient.getTransactions()).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("JupiterClient#getTransaction", () => {
    it("should GET the /custodian/transaction/:id endpoint", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(
        `${mockUrl}/custodian/transaction/xxx`,
        {
          headers: {
            Authorization: `Bearer ${mockJwt}`,
          },
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(jupiterClient.getTransaction("xxx")).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("JupiterClient#getCustomerProof", () => {
    it("should POST the /custodian/customer-proof endpoint", async () => {
      ...
      const result = await jupiterClient.getCustomerProof(
        "customerId",
        "issuer"
      );
      ...
      expect(fetchMock).toHaveBeenCalledWith(`${mockUrl}/customer-proof`, {
        body:
          '{"customerId":"customerId","issuer":"issuer","custodian":"jupiter"}',
        headers: {
          Authorization: "Bearer mock-jwt",
        },
        method: "POST",
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(
        jupiterClient.getCustomerProof("customerId", "issuer")
      ).rejects.toThrow(CustodianApiError);
    });
  });
  ...
  describe("JupiterClient#signTypedData_v4", () => {
    it("should POST the /custodian/signature endpoint", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(`${mockUrl}/custodian/signature`, {
        body:
          '{"accountId":"test","payload":{"types":{"EIP712Domain":[]},"primaryType":"test","domain":{"name":"test"},"message":{}},"signatureVersion":"V4"}',
        headers: {
          Authorization: "Bearer mock-jwt",
        },
        method: "POST",
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(
        jupiterClient.signTypedData_v4("test", buffer, "V4")
      ).rejects.toThrow(CustodianApiError);
    });
  });
  ...
  describe("JupiterClient#signPersonalMessage", () => {
    it("should POST the /custodian/personal-signature endpoint", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(
        `${mockUrl}/custodian/personal-signature`,
        {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(jupiterClient.signPersonalMessage("test", buffer)).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("getSupportedChains", () => {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(jupiterClient.getSupportedChains()).rejects.toThrow(
        CustodianApiError
      );
    });
  });
