...
describe("CactusClient", () => {
  ...
  describe("getAccessToken", () => {
    ...
    it("should fail if no access token is returned", async () => {
      ...
      expect(cactusClient.getAccessToken()).rejects.toThrowError(
        "No access token"
      );
    });
    ...
    it("should call the Cactus API and get an access token", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(`${mockUrl}/tokens`, {
        body:
          '{"grantType":"refresh_token","refreshToken":"mock-refresh-token"}',
        method: "POST",
      });
    });
  });
  ...
  describe("CactusClient#getEthereumAccounts", () => {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(cactusClient.getEthereumAccounts()).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("CactusClient#createTransaction", () => {
    it("should POST the transactions endpoint", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(
        ...
        {
          body:
            '{"to":"test","from":"test","value":"test","data":"test","gasLimit":"test","note":"hello","gasPrice":"test"}',
          headers: {
            Authorization: "Bearer 123",
          },
          method: "POST",
    ...
    it("should POST the /custodian/transaction endpoint with EIP-1559 params", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(
        ...
        {
          body:
            '{"to":"test","from":"test","value":"test","data":"test","gasLimit":"test","note":"Hello","maxPriorityFeePerGas":"test","maxFeePerGas":"test"}',
          headers: {
            Authorization: "Bearer 123",
          },
          method: "POST",
  ...
  describe("CactusClient#getTransactions", () => {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(cactusClient.getTransactions(4)).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("CactusClient#getTransaction", () => {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      await expect(cactusClient.getTransaction("xxx")).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("CactusClient#getCustomerProof", () => {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(cactusClient.getCustomerProof()).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("CactusClient#signTypedData_v4", () => {
    it("should POST the /signatures endpoint", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(
        ...
        {
          body:
            '{"address":"test","payload":{"types":{"EIP712Domain":[]},"primaryType":"test","domain":{"name":"test"},"message":{}},"signatureVersion":"V4"}',
          headers: {
            Authorization: "Bearer 123",
          },
          method: "POST",
  ...
  describe("CactusClient#signPersonalMessage", () => {
    it("should POST the /signatures endpoint", async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(`${mockUrl}/signatures`, {
        body:
          '{"address":"test","payload":{"message":"0xdeadbeef"},"signatureVersion":"personalSign"}',
        headers: {
          Authorization: "Bearer 123",
        },
        method: "POST",
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      expect(cactusClient.signPersonalMessage("test", message)).rejects.toThrow(
        CustodianApiError
      );
    });
  });
  ...
  describe("getChainIds", () => {
    ...
    it("should fail if an exception is thrown by the HTTP client", async () => {
      ...
      await expect(cactusClient.getChainIds()).rejects.toThrow(
        CustodianApiError
      );
    });
  });
