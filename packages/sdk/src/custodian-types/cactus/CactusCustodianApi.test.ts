...
describe("CactusCustodianApi", () => {
  ...
  beforeEach(() => {
    ...
    mockedCactusClientInstance.getTransactions = jest
      .fn()
      .mockImplementation(() => mockCactusGetTransactionsResult);

    mockedCactusClientInstance.getTransaction = jest
      .fn()
      .mockImplementation(() => mockCactusGetTransactionsResult[0]);
    ...
    mockedCactusClientInstance.signTypedData_v4 = jest
      .fn()
    ...
    mockedCactusClientInstance.getChainIds = jest
      .fn()
    ...
    it("gets a single transaction by id", async () => {
      ...
      expect(result).toEqual({
        ...
        maxPriorityFeePerGas:
          mockCactusGetTransactionsResult[0].maxPriorityFeePerGas,
      });
  ...
  describe("CactusCustodianApi#getAllTransactions", () => {
    it("is not implemented", async () => {
      await expect(
        cactusCustodianApi.getAllTransactions()
